Day1 - Day4 as per TOC - 2Feb2026 - Two Pointers and Hashtable
    ...
    Longest histogram rectangle - https://leetcode.com/problems/largest-rectangle-in-histogram/description/?envType=problem-list-v2&envId=array
    
    roman to integer - https://leetcode.com/problems/roman-to-integer/description/?envType=problem-list-v2&envId=hash-table
    
    Integer to roman - https://leetcode.com/problems/integer-to-roman/?envType=problem-list-v2&envId=hash-table
    Task:
...
Day2 - Day5 as per TOC - 3Feb2026 - Sliding Window
    ...
    Fruits and Basket - https://leetcode.com/problems/fruit-into-baskets/description/
